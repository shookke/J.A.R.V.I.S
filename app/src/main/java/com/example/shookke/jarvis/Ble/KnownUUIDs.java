...
import com.example.shookke.jarvis.update.BackgroundService;
...
public class KnownUUIDs extends StandardUUIDs {
    ...
    static {
        ...
        aMap.put(BackgroundService.UUID_SERVICE.toUpperCase(), "Nordic UART");
    ...
    static {
        ...
        // Uart
        aMap.put(BackgroundService.UUID_RX.toUpperCase(), "RX Buffer");
        aMap.put(BackgroundService.UUID_TX.toUpperCase(), "TX Buffer");
        aMap.put(BackgroundService.UUID_DFU.toUpperCase(), "DFU Service");
